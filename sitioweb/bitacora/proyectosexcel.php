    ...
    <div class="main-content">
        <form id="frmExcel" name="frmExcel" method="POST" enctype="multipart/form-data">
            <div class="switch-holder">
                <h4><b>Creacion de Proyectos (lectura de datos de Excel)</b></h4>
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < $numHojas; $i++) {
                                ...
                                foreach ($leerArchivo as $renglon) {
                                    if (!empty($renglon[0]) && !empty($renglon[1]) && !empty($renglon[2]) && !empty($renglon[3]) && !empty($renglon[4]) && !empty($renglon[5])) {
                                        $datos = $cliente->CrearProyecto($renglon[0], $renglon[1], $renglon[2], $renglon[3], ($renglon[4]), $_SESSION['usuCve']);
                                        ...
                                        echo '<td>' . htmlspecialchars($renglon[5]) . '</td>';
                                        echo '</tr>';
                                    }
                                }
                            }
